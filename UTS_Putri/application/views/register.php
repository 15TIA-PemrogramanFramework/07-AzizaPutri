                        ...
                        <form action="<?php echo $action?>" role="form" method="post">
                            <fieldset>
                                <div class="form-group">
                                    <input class="form-control" placeholder="Nama" name="nama_customer" type="text" value="">
                                </div>
                                <div class="form-group">
                                ...
                                <input type="submit" value="<?php echo $button; ?>" class="btn btn-lg btn-success btn-block">
                            </fieldset>
                        </form>
                    </div>
                </div>
